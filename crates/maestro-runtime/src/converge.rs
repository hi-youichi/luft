...
async fn generate_findings(
    ...
    for item in items {
        for _ in 0..producers_per_item {
            ...
            let task = maestro_core::contract::backend::AgentTask {
                agent_id,
...
mod tests {
    ...
    use maestro_core::contract::finding::{Location, Severity};
    use maestro_core::contract::ids::TokenUsage;
    use maestro_core::scheduler::{BackendRegistry, RetryPolicy, SchedulerConfig};
    use maestro_core::{AgentTask, MockBackend, MockBehavior};
