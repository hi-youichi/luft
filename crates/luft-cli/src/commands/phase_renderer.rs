...
use luft::core::contract::ids::{AgentId, PhaseId, RunId, TokenUsage};
...
mod tests {
    use super::*;
    use luft::core::contract::event::{AgentEvent, ProgressDelta, RunStatus};
    use luft::core::contract::finding::Finding;
    use luft::core::contract::ids::{AgentId, RunId, TokenUsage};
    ...
    fn evt_agent_done(agent_id: AgentId, tokens: TokenUsage) -> AgentEvent {
        AgentEvent::AgentDone {
            run_id: RunId::now_v7(),
            agent_id,
            status: luft::core::contract::backend::AgentStatus::Ok,
            tokens,
            elapsed_ms: 1_200,
            name: Some("researcher-a".into()),
            agent_seq: 0,
