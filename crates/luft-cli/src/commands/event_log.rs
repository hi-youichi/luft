...
use anyhow::Result;
use luft::core::contract::event::{AgentEvent, ProgressDelta};
use std::fs::File;
...
mod tests {
    ...
    use luft::core::contract::event::LogLevel;
    use luft::core::contract::event::ProgressDelta;
    use luft::core::contract::event::RunStatus;
    ...
    fn jsonl_matches_serde_to_string() {
        ...
        let dir = std::env::temp_dir().join(format!("luft_evlog_{}", uuid::Uuid::now_v7()));
