...
mod tests {
    ...
    fn with_events_default_limit() {
        ...
        let run_id = rid();
        let events = [
            luft::core::contract::event::AgentEvent::RunStarted {
                run_id,
                task: "my task".into(),
                ts: chrono::Utc::now(),
            },
            luft::core::contract::event::AgentEvent::Log {
                run_id,
                agent_id: None,
                level: luft::core::contract::event::LogLevel::Info,
                msg: "hello".into(),
            },
        ];
    ...
    fn with_events_custom_limit() {
        ...
        let events: Vec<_> = (0..10)
            .map(|i| luft::core::contract::event::AgentEvent::Log {
                run_id,
                agent_id: None,
                level: luft::core::contract::event::LogLevel::Info,
                msg: format!("msg {}", i),
