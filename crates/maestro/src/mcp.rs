//! `mcp` — Maestro MCP data-plane server (M4).
//!
//! This module implements the MCP server that agents connect to for structured reporting.
//! It provides tools for agents to report findings, artifacts, and logs back to Maestro.
//!
//! MCP Tools provided:
...
use maestro_core::contract::finding::{Finding, Severity};
use maestro_core::contract::ids::{AgentId, RunId};
    ...
    match name {
        "report_finding" => {
            ...
            let location =
                arguments
                    .get("location")
                    .map(|loc| maestro_core::contract::finding::Location {
...
mod tests {
    ...
    fn test_add_finding_and_get_it() {
        ...
        let finding = Finding {
            ...
            location: Some(maestro_core::contract::finding::Location {
