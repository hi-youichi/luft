...
use maestro::adapters::AcpAdapter;
use maestro::core::contract::backend::{AgentBackend, AgentStatus, AgentTask, RunContext};
...
async fn acp_cancel_returns_promptly() {
    ...
    assert!(
        matches!(
            err,
            maestro::core::contract::backend::BackendError::Cancelled
        ),
